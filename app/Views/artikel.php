 ...
 <body>
     ...
     <header class="text-black text-center py-5 mb-4" style="background-color: #96B6C5;">
         <div class="container">
             <h1 class="font-weight-bold">Artikel Tempat Wisata</h1>
             <p>Disini kami menyediakan artikel pendukung agar anda mendapatkan informasi lengkap terkait tempat wisata yang akan anda kunjungi.</p>
         </div>
     </header>
     <div class="container">
         ...
         <div class="row">
             <?php
                ...
                foreach ($lokasiWisata as $lokasi) :
                    // Logika filter
                    $showArticle = true;
                     ...
                     <div class="col-md-4 mb-4">
                         <div class="card">
                             <?php
                                ...
                                $fotoArray = explode(',', $lokasi['foto_lokasi']);
                             ...
                             <img class="card-img-top" style="width:auto; height: 150px; object-fit:cover;" src="<?= $gambarPath ?>" alt="<?= $lokasi['nama_lokasi'] ?>">
             ...
             <?php if (!$articleFound) : ?>
                 <div class="col-md-12">
                     <p class="text-center">Belum ada artikel yang sesuai dengan filter.</p>
                 </div>
             <?php endif; ?>
         </div>
